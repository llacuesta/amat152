...
function App() {
  ...
  const prioritizedNodes = usePriorityNodesStore(
    (state) => state.prioritizedNodes
  );
  const setPrioritizedNodes = usePriorityNodesStore(
    (state) => state.setPrioritizedNodes
  );
      ...
      <div className="absolute top-2.5 left-2.5 z-50">
        <div className="bg-gray-950/70 h-32 w-36 rounded-xl outline outline-[1px] outline-white/50 backdrop-blur-xl flex flex-col justify-center p-3">
          <div className="flex flex-row gap-2 text-xs font-bold mb-1 items-center">
            <div><IconInfoCircle size={14}/></div>
            LEGEND
          </div>
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <button className="btn btn-primary btn-sm mt-3">APPLY</button>
              </div>
              ...
              <div className="flex justify-between items-center mt-4">
                ...
                <select value={null} className="select select-sm max-w-xs">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedNodes.size == 0 ? (
                    ...
                    [...selectedNodes].map((cid) => {
                      return <SelectedCourseTag key={cid} courseID={cid} nodes={nodes} setNodes={setNodes}/>;
                    })
                  )}
                </div>
              </div>
